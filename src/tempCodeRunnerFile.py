...
if empty_check(conn,cur,'orders'):
    ...
    for i in range(75000):
        ...
        order_timestamp = fake.date_time_between( start_date='-1y',end_date='today')
    ...
    insertion(conn,cur,'orders',orders_insertion_columns, orders_insert_tuples , 'order_id' , on_conflict=False)
